...
import { FaHtml5, FaCss3Alt, FaJsSquare, FaReact, FaDatabase, FaCode, FaJava, FaNodeJs, FaBootstrap } from 'react-icons/fa';
...
function Skills() {
  ...
  const skills = [
    ...
    {
      id: 4,
      icon: <FaJsSquare className="text-6xl text-yellow-300 mb-4" />,
      name: 'JavaScript',
   ...
   
    {
      ...
      {
        id:6,
        icon:    <FaBootstrap  className="text-6xl text-purple-600" />,
        name : 'Bootstrap',
        description: 'Versatile language for building secure and scalable applications',
    },
    {
        id:7,
        icon: <CgFigma   className="text-6xl text-black" />,
        name : 'Figma',
        description: 'Versatile language for building secure and scalable applications',
    },
      {
      ...
      {
        id:9,
        icon: <FaNodeJs  className="text-6xl text-green-700" />,
        name : 'Node.js',
        description: 'Versatile language for building secure and scalable applications',
    },
     {
        id:10,
        icon: <SiExpress  className="text-6xl text-black" />,
        name : 'Express.js',
        description: 'Versatile language for building secure and scalable applications',
    },
     {
     ...
     {
      id: 12,
      icon: <GrMysql  className="text-6xl text-blue-500 mb-4" />,
      name: 'MySQL',
